export const translations = {
  ko: {
    ...
    imageConverter: {
      ...
      upload: {
        title: "이미지를 여기에 드롭하세요",
        subtitle: "변환할 이미지 파일을 선택하거나 드래그해서 올려주세요",
      ...
      outputFormat: "출력 형식",
      quality: "품질 (JPEG/WEBP만 해당)",
      singleConvert: "단일 변환",
      iconGenerate: "아이콘 생성",
      iconDescription: "Windows 아이콘(.ico) 파일을 생성합니다.",
      generateIcon: "아이콘 생성",
      multiSizeIcon: "멀티 사이즈 아이콘 생성",
      multiDescription: "여러 크기의 아이콘을 포함한 .ico 파일을 생성합니다.",
      generateMulti: "멀티 아이콘 생성",
      results: "변환 결과",
      resultsDescription: "변환된 이미지들을 다운로드하세요.",
      downloadAll: "모두 다운로드",
      converting: "변환 중...",
  ...
  en: {
    ...
    imageConverter: {
      ...
      iconGenerate: "Icon Generation",
      iconDescription: "Generate Windows icon (.ico) files.",
      generateIcon: "Generate Icon",
      multiSizeIcon: "Multi-size Icon Generation",
      multiDescription: "Generate .ico file with multiple icon sizes.",
      generateMulti: "Generate Multi Icon",
      results: "Conversion Results",
      resultsDescription: "Download your converted images.",
